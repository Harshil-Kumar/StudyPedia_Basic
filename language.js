...
async function getMessage(e) {
  ...
  const finalSearchTerm = "Explain the following concept: " + searchTerm+ "totally in" +selectedOption+ "language";
...
function openDifferencePage() {
  window.open('lang_difference.html', '_blank');
}
...
function openConnectionPage() {
  window.open('lang_connection.html', '_blank');
}
