...
async function getWordDifference(input1, input2) {
  const finalSearchTerm = "What is the difference between " + input1 + " and " + input2 + "? Dont ask any questions in return. Give me example if possible.";
...
languageSelect.addEventListener('change', function() {
  ...
  window.location.href = `lang_difference.html?option=${selectedOption}`;
});
